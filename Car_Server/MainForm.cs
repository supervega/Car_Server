...
{
    public class PathController : System.Windows.Forms.Form
    {
        ...
        private int LastX;
        private int LastY;
        private double Angle,acceleration=0;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PathController));
            ...
            this.groupBox2.Controls.Add(this.txtacceleration);
            ...
            this.gbComandos.Location = new System.Drawing.Point(8, 157);
            ...
            this.pbTerrain.Image = global::Car_Server.Properties.Resources.Map1;
            ...
            // txtacceleration
            // 
            this.txtacceleration.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtacceleration.Location = new System.Drawing.Point(96, 32);
            this.txtacceleration.Name = "txtacceleration";
            this.txtacceleration.Size = new System.Drawing.Size(40, 16);
            this.txtacceleration.TabIndex = 31;
            this.txtacceleration.Text = "0,00";
            this.txtacceleration.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // PathController
            // 
            ...
            this.Name = "PathController";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Fuzzy Auto Guided Vehicle Sample";
            this.Load += new System.EventHandler(this.PathController_Load);
        ...
        private void DoInference( )
        {
            ...
            MainForm.Core_unit.Run_Distance_acceleration(new float[] { (float)Convert.ToDouble(txtFront.Text) /5f, (float)Convert.ToDouble(txtRight.Text) /5f, (float)Convert.ToDouble(txtLeft.Text) / 5f, LastF, LastR, LastL}, MainForm.RunInferenceTracer);
            LastF = LastF - (float)Convert.ToDouble(txtFront.Text) / 5;
            LastR = LastR - (float)Convert.ToDouble(txtRight.Text) / 5;
            LastL = LastL - (float)Convert.ToDouble(txtLeft.Text) / 5;
            // Setting outputs
            try
            {
                float Left = 0, Right = 0;
                foreach (FuzzyLogic_Unit.Variable V in FuzzyLogic_Unit.Core.variables)
                {
                    if (V.VariableType == FuzzyLogic_Unit.Variable.VarType.Output && V.VariableName=="LDirection")
                    {
                        //Angle = V.CrispOutput;
                        Left = (V.CrispOutput * 90) / 100;
                        //txtAngle.Text = Angle.ToString("##0.#0");
                        //Angle += NewAngle;
                    }
                    if (V.VariableType == FuzzyLogic_Unit.Variable.VarType.Output && V.VariableName == "RDirection")
                    {
                        //Angle = V.CrispOutput;
                        Right = (V.CrispOutput * 90) / 100;
                        //txtAngle.Text = Angle.ToString("##0.#0");
                        //Angle += NewAngle;
                    }
                    if (V.VariableType == FuzzyLogic_Unit.Variable.VarType.Output && V.VariableName.ToLower() == "acceleration")
                    {
                        acceleration = -V.CrispOutput/1;
                        if (acceleration > -1)
                            acceleration = -1;
                        txtacceleration.Text = (acceleration*-1).ToString();
                        //Angle += NewAngle;
                    }
                }
                if (Left - Right > 0)
        ...
        private void pbTerrain_MouseMove( object sender, System.Windows.Forms.MouseEventArgs e )
        {
            ...
            if ( c != Color.Yellow )
            {
                g.FillRectangle( new SolidBrush( c ), e.X - 20, e.Y - 20, 40, 40 );
        ...
        private void MoveAGV( )
        {
            ...
            Offset += Inc;
            int IncX = Convert.ToInt32( acceleration * Math.Cos( rad ) );
            int IncY = Convert.ToInt32(acceleration * Math.Sin(rad));
        ...
        private void PathController_Load(object sender, EventArgs e)
        {
