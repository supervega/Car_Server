...
{
    public partial class InitNN : Form
    {
        ...
        private void CBMarkAsOutput_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void BtnCreateNewLayer_Click_1(object sender, EventArgs e)
        {
        ...
        private void EditNeurons_Click(object sender, EventArgs e)
        {
        ...
        private void NUDBias_ValueChanged_1(object sender, EventArgs e)
        {
            Manager.CurrentLayer.CurrentNeuron.Bias = (float)NUDBias.Value;
        }

        private void NUDLearningRate_ValueChanged_1(object sender, EventArgs e)
        {
        ...
        private void NUDInputCount_ValueChanged_1(object sender, EventArgs e)
        {
            if (NUDInputCount.Value > NUDInputSlot.Value)
            {
                MessageBox.Show("Cannot exceeds input slot size.");
        ...
        private void BtnAddNeuron_Click_1(object sender, EventArgs e)
        {
            if (NUDInputCount.Value > NUDInputSlot.Value)
            {
                MessageBox.Show("Cannot exceeds input slot size.");
        ...
        private void BtnClearLayerInfo_Click_1(object sender, EventArgs e)
        {
        ...
        private void BtnXORScript_Click_1(object sender, EventArgs e)
        {
            do
            {
                ArrayList OutputVector = new ArrayList();
        ...
        private void BtnAddDesiredOutput_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnTestSample_Click_1(object sender, EventArgs e)
        {
